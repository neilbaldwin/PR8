...
@a:		jsr @read_bits	;debounce joypad
		ldx PAD2_jt	;by waiting until the joypad returns
		jsr @read_bits	;two consecutive equal values
		cpx PAD2_jt
		bne @a
...
@read_bits:
		...
		lda #$01
		sta PAD2_jt		;init for 8 reads
		sta $4016		;init I/O port for joystick read
		lsr a
		sta $4016
@i:		lda $4017		;serially read 8 2-bit values from I/O port
		and #$03		;%00=%0,%01=%1,%10=%1,%11=%1
		cmp #$01
		rol PAD2_jt
		bcc @i
